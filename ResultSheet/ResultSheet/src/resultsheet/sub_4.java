 ...
 * @author Coder
 */
public class sub_4 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sub_4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
