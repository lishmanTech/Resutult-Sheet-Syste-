 ...
 * @author Coder
 */
public class sub_3 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sub_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
