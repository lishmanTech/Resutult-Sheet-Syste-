 ...
 * @author Coder
 */
public class sub_8 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sub_8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
